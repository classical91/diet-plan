...
const CONTENT_PAGES = [
  { file: "nutrition.html", path: "/nutrition", title: "Nutrition Guide" },
  ...
  { file: "work-meals.html", path: "/work-meals", title: "Daily Meal Planner" },
  { file: "weekly-calendar.html", path: "/weekly-calendar", title: "Weekly Meal Calendar" },

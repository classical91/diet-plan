...
// ── My dinner idea bank ─────────────────────────────────────────────────────
// Simple dinner titles built from dinner-usable foods. These are turned into
// pickable dinner meals by buildDinnerIdeas() in dietPlannerLogic.js.
export const dinnerTitles = [
  "Turkey Burger",
  "Lean Beef Burger",
  "Chicken Burger",
  "Chicken Breast",
...
// Non-dinner items kept in their own buckets so they never become dinner titles.
export const snackTitles = ["Bars", "Granola", "Chocolate", "Ice Cream", "Chips"];
export const drinkTitles = ["Water", "Coffee", "Tea", "Kombucha", "Juice", "Soda"];
export const nonFoodItems = ["Soap", "Shampoo", "Dish Soap", "Sunscreen", "Serum", "Epsom Salt"];
export const avoidOrLimit = ["Hot Dogs", "Cream Cheese", "Pancake Mix", "Pizza Pops", "Garlic Fingers"];
